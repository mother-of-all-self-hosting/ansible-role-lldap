...
lldap_database_mysql_socket_enabled: false

# Disable the connection to the Postgres server via a Unix socket
lldap_database_postgres_socket_enabled: false
```
